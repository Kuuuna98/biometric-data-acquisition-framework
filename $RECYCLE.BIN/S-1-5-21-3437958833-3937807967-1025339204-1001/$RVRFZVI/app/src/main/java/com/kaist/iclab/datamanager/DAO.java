...
//                ");");
    ...
    public static String SensingTime = "SensingTime";
  ...
  //  public static String LOG_FIELD_PhoneNumber = "PhoneNumber";
    ...
    public static int NEW_SensingTime = 0;
   ...
   /* public long writeLog(long id, ContentValues contentValues) throws Exception {
    ...
    /*TimeWrite*/
    public long writeTime(long id, ContentValues contentValues) throws Exception {
        Log.d(TAG, "writeTime:");
        SQLiteDatabase database = getWritableDatabase();
        //database.beginTransaction();
        if (id == NEW_SensingTime) {
            id = database.insert(SensingTime, null, contentValues);
            //database.setTransactionSuccessful();
            //database.endTransaction();
        } else {
            database.update(SensingTime, contentValues, "_id = ?", new String[]{ id + "" });
        }
        return id;
    }
    ...
    public int deleteAll() throws Exception{
        ...
        database.delete(MainActivity,null, null);
        return database.delete(SensingTime,null, null);
...
//    }
    ...
    public Cursor querySensingTime(String[] projection, String selection, String[] selectionArgs) {
        return getReadableDatabase().query(SensingTime, projection, selection, selectionArgs, null, null, "time ASC");
    }
